...
class BeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bee" do
    assert_difference('Bee.count') do
      post bees_url, params: { bee: { adresse: @bee.adresse, descrption: @bee.descrption, picture: @bee.picture } }
    end
  ...
  test "should update bee" do
    patch bee_url(@bee), params: { bee: { adresse: @bee.adresse, descrption: @bee.descrption, picture: @bee.picture } }
